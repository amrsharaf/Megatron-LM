...
LOG_BASE=/TEE2-lustre/users/bnorick/projects/very_large_lm/gpt3_6.7b/logs
CKPT_BASE=/TEE2-lustre/users/bnorick/projects/very_large_lm/gpt3_6.7b/checkpoints
TENSORBOARD_BASE=/TEE2-lustre/users/bnorick/projects/very_large_lm/gpt3_6.7b/tensorboard
...
# Data paths
DATA_PATH=/TEE2-lustre/users/bnorick/projects/very_large_lm/data/indexed
gpt_options="${gpt_options} \
        ...
        --data-blend \
                0.79 $DATA_PATH/ccnet \
                0.0046 $DATA_PATH/1_text_document \
                0.0759 $DATA_PATH/2_text_document \
                0.0267 $DATA_PATH/4_text_document \
                0.072 $DATA_PATH/3_text_document \
                0.0308 $DATA_PATH/5_text_document \
        --data-impl mmap"
...
# PP=4 MP=2 too low util, 5 tflop
# PP=4 MP=1 OOM
# PP=2 MP=2 OOM
...
LOGDIR=${LOG_BASE}/seq${SEQ_LEN}
mkdir -p ${LOGDIR}

TENSORBOARD_PATH=$TENSORBOARD_BASE/gpus${GPUS}_pp${PP}_mp${MP}_dp${DP}_h${HEADS}_hd${HIDDEN}_ly${LAYERS}_bt${TRAIN_BATCH_SIZE}_gas${GAS}_lr${LR}-${EXP_NAME}
LOGFILE="${LOGDIR}/log-gpus${GPUS}_pp${PP}_mp${MP}_dp${DP}_h${HEADS}_hd${HIDDEN}_ly${LAYERS}_bt${TRAIN_BATCH_SIZE}_gas${GAS}_lr${LR}-${EXP_NAME}.txt"
